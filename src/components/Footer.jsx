...
function Footer() {
    return (
        ...
        <footer className="footer p-10 bg-base-100 text-neutral-content container-fluid">
            <aside>
                <img src="/Elektropolnilnice_White_NoBg_2010x1080.png" alt="Logo" className="h-[50px]"/>
                <p>&copy; {new Date().getFullYear()} Elektropolnilnice i-+. <br/> All rights reserved.</p>
            </aside>
            <nav>
                <h6 className="footer-title">In cooperation</h6>
